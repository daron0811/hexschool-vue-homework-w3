    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="list-group">
          <a v-for="drink in drinks" :key="drink.id" href="#" class="list-group-item list-group-item-action"
      ...
      <div class="col-md-8">
        ...
        <div v-else>
          ...
          <textarea class="form-control mb-3" rows="3" placeholder="備註" v-model="description"></textarea>
          <div class="text-end">
